...
C. Docs ??update roadmap, PROJECT_STATE, and NEXT_WORK_PROMPT.
```
...
3. Read:
   ...
   - docs/agent/NEXT_WORK_PROMPT.md
...
C. Docs ??update roadmap (mark chain-rule done, move tangent-line-equation from
   Open to Shipped, Phase 4 complete), PROJECT_STATE, and NEXT_WORK_PROMPT
...
4. `docs/roadmap.md`, `docs/agent/PROJECT_STATE.md`, and
   `docs/agent/NEXT_WORK_PROMPT.md` are in sync with the code.
```
