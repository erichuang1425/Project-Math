...
3. Read `docs/agent/PROJECT_STATE.md`, `docs/agent/NEXT_WORK_PROMPT.md`, and this file.
...
- Maintain `docs/agent/NEXT_WORK_PROMPT.md` as the single durable next prompt.
...
4. Leave the next concrete task in `docs/agent/NEXT_WORK_PROMPT.md`.
